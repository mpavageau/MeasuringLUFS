...
MeasuringLufsComponent::~MeasuringLufsComponent()
{
...
void MeasuringLufsComponent::paint( juce::Graphics & g )
{
#ifdef TESTCOLORS
...
void MeasuringLufsComponent::updateAudioDeviceName()
{
...
void MeasuringLufsComponent::buttonClicked( juce::Button* )
{
    ...
    juce::DialogWindow::showModalDialog( "Select the Audio Device", &component, this, LUFS_COLOR_BACKGROUND, true, false, false );
...
void MeasuringLufsComponent::audioDeviceIOCallback( const float** inputChannelData, int numInputChannels, float** /*outputChannelData*/, int /*numOutputChannels*/, int numSamples)
{
...
void MeasuringLufsComponent::audioDeviceAboutToStart( juce::AudioIODevice* device )
{
    m_processor.prepareToPlay( device->getCurrentSampleRate(), device->getCurrentBufferSizeSamples() );
}

void MeasuringLufsComponent::audioDeviceStopped()
{
}

void MeasuringLufsComponent::audioDeviceError( const juce::String & /*errorMessage*/ )
{
}

void MeasuringLufsComponent::resized()
{
