...
#ifndef __LUFS_MEASURINGLUFSCOMPONENT_H__
#define __LUFS_MEASURINGLUFSCOMPONENT_H__

#include "LufsAudioProcessor.h"

class MeasuringLufsComponent 
...
public:
    ...
    MeasuringLufsComponent( bool _hostAppContext );
    virtual ~MeasuringLufsComponent();
...
#endif  // __LUFS_MEASURINGLUFSCOMPONENT_H__
